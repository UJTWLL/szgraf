...
void init_entities(World *world) {
    ...
    float popcorn_mat_ambient[] = {0.05f,0.05f,0.05f,1.0f};
    float popcorn_mat_diffuse[] = {0.4f,0.4f,0.4f,1.0f};
    float popcorn_mat_specular[] = {0.6f,0.6f,0.6f,1.0f};
    float popcorn_mat_shine = 10.0f;

	double vx = 0.01;
	double vy = 0.01;
	double vz = 0.01;

    load_model("models//popcorn.obj", &world->object.model);
    world->object.texture = load_texture("textures//popcorn_texture.jpg");
    init_object(&world->object, 0, 0, popcorn_mat_ambient, popcorn_mat_diffuse, popcorn_mat_specular, popcorn_mat_shine, vx, vy, vz);
